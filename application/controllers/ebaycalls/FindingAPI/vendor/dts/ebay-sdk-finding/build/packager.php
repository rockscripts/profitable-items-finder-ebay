...
$autoLoader = 'dts-finding-autoloader.php';
...
$packager->createZip(__DIR__ . '/artifacts/dts-finding.zip');
$packager->createPhar(__DIR__ . '/artifacts/dts-finding.phar', null, $autoLoader);
