...
<div class="well">
	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				...
				<h4 class="page-header">Items with Profit / <b><?=$_GET['sellerID']?></b></h4>
				<div class="buttons-area">					
					...
					<select id="actions_main">
							...
							<option value="2">Remove by quantity</option>	
					</select>
					<!-- Pages:    <select id="pages">
						...
						<select id="actions_main">
							...
							<option value="1">Remove Items Selected</option>
							<option value="2">Remove Items by qty</option>							
	...
	if(is_array($profitable_items )):
	 ...
	 <td>
			...
			<td  class="totalItemsSold-<?=$profitable_item->itemID?>"><?=$profitable_item->totalItemsSold?></td>
            ...
            <td>
			 <select id="actions_item" item-id="<?=$profitable_item->itemID?>">
				<option>Actions</option>
				<option value="0">Update Item</option>
