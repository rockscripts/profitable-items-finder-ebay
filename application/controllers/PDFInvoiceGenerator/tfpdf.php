...
function AddFont($family, $style='', $file='', $uni=false)
{
	...
	if ($uni) {
		if (defined("_SYSTEM_TTFONTS") && file_exists(_SYSTEM_TTFONTS.$file )) { $ttffilename = './font/unifont/'.$file ; }
		else { $ttffilename = './font/unifont/'.$file ; }
		$unifilename = 'font/unifont/'.strtolower(substr($file ,0,(strpos($file ,'.'))));
		$name = '';
		$originalsize = 0;
