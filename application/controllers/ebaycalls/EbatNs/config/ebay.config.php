...
app-key-prod  = rockscri-7a27-4c7a-b095-e8cbe5ebb63bd
...
;server
token-pickup-file=/opt/lampp/htdocs/profitable-items-finder-ebay/application/controllers/ebaycalls/EbatNs/config/my.token
token-mode=1
*/ ?>